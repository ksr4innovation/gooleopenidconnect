...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__token_storage__ = __webpack_require__("../../../../../src/app/token.storage.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(tokenStorage) {
        ...
        tokenStorage.auth().subscribe(function (data) {
    ...
    AppComponent.prototype.userDetails = function () {
        var _this = this;
        this.tokenStorage.userDetail().subscribe(function (data) {
            _this.userResp = data;
        });
    };
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__token_storage__["a" /* TokenStorage */]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__token_storage__ = __webpack_require__("../../../../../src/app/token.storage.ts");
...
var Interceptor = /** @class */ (function () {
    ...
    Interceptor = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__token_storage__["a" /* TokenStorage */]])
    ], Interceptor);
    return Interceptor;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_interceptor__ = __webpack_require__("../../../../../src/app/app.interceptor.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__token_storage__ = __webpack_require__("../../../../../src/app/token.storage.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            ...
            providers: [
                __WEBPACK_IMPORTED_MODULE_5__token_storage__["a" /* TokenStorage */], {
                    provide: __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["a" /* HTTP_INTERCEPTORS */],
                    useClass: __WEBPACK_IMPORTED_MODULE_4__app_interceptor__["a" /* Interceptor */],
                    multi: true,
                }
            ],
...
var TokenStorage = /** @class */ (function () {
    ...
    TokenStorage.prototype.auth = function () {
        console.log('   from atuh method ');
        return this.http.get('http://localhost:8080/api/rest/home');
    };
    TokenStorage.prototype.userDetail = function () {
        console.log('   userDetail ');
        return this.http.get('http://localhost:8080/api/rest/user');
    };
